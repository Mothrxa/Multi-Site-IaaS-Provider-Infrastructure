...
function ITWorkloads() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "var(--gap-grid)" }}>
        <Card><Stat label="VMs running" value="2,418" delta="+42 this week" deltaTone="good"/></Card>
        <Card><Stat label="Containers running" value="764" delta="+18 today" deltaTone="good"/></Card>
        <Card><Stat label="Errored workloads" value="11" delta="3 customer-side" deltaTone="warn"/></Card>
        <Card><Stat label="Customer-provisioned (24h)" value="184" hint="all via portal/API"/></Card>
      </div>
