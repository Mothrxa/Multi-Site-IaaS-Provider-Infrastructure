      ...
      <div className="section-inner">
        ...
        <div className="bento" onMouseMove={e => {
          ...
          <div className="cell s-4 tall reveal">
            ...
            <p>Terraform + Ansible under the hood. You only ever see a green light.</p>
          ...
          <div className="cell s-8 reveal d1">
            ...
            <div style={{ display:"flex", gap:16, alignItems:"flex-start" }}>
              ...
              <div>
                ...
                <p>Web console, REST API, CLI, Terraform provider. Every action you can do in the UI has an API equivalent. Automate everything.</p>
              </div>
            </div>
            <div style={{ marginTop:20, display:"flex", gap:8, flexWrap:"wrap" }}>
              {["REST API","Terraform","CLI","Webhooks","SDKs"].map(t => (
        ...
        <div className="g cols-12 reveal" style={{ alignItems: "center", gap: 48 }}>
          <div style={{ gridColumn: "span 5" }}>
            ...
            <p className="dim" style={{ fontSize: 16.5, lineHeight: 1.6, marginTop: 16 }}>
              Click it in the console, script it with the CLI, or commit it to version control with Terraform.
            ...
            <div className="row" style={{ gap: 22, marginTop: 26 }}>
              ...
              <div className="row" style={{ gap: 9 }}><I.layers size={18} stroke="var(--accent)"/><span style={{ fontSize: 14, fontWeight: 500 }}>Terraform</span></div>
            </div>
          </div>
          <div style={{ gridColumn: "span 7" }}>
...
function Testimonials() {
  const row1 = [
    ...
    { q: "Deploys that took our team 20 minutes now take under a minute. The Terraform provider is genuinely first-class.", n: "Yacine Rahmani", r: "Platform Lead, kilo" },
...
function FooterMkt() {
  const cols = {
    ...
    Resources: ["Documentation","API reference","CLI","Terraform provider","Status","Changelog"],
